function [allData, scenario, sensors] = example4()
...
% Generated on: 06-Dec-2023 07:10:52
...
car = vehicle(scenario, ...
    ...
    'Name', 'Car');
waypoints = [16.9 3.4 0;
    25.9 3.3 0;
    32.4 3.3 0;
    37.4 3.3 0;
    42.8 3.1 0;
    48.1 2.9 0];
speed = [0;20;30;40;60;60];
waittime = [0;0;0;0;0;0];
trajectory(car, waypoints, speed, waittime);

targetCar = vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [8.32118828338026 3.04758537921546 0], ...
    'Mesh', driving.scenario.carMesh, ...
    'Name', 'TargetCar');
waypoints = [8.32118828338026 3.04758537921546 0;
    15.9 3.2 0;
    19.9 3.2 0;
    23.4 3.2 0;
    27.7 3.2 0;
    33.9 3 0];
speed = [0;15;30;40;40;40];
waittime = [0;0;0;0;0;0];
...
egoVehicle = vehicle(scenario, ...
    'ClassID', 1, ...
    'Position', [-0.546365775663004 2.76365921371885 0], ...
    'Mesh', driving.scenario.carMesh, ...
    'Name', 'Car2');
waypoints = [-0.546365775663004 2.76365921371885 0;
    13.2 3.5 0;
    20.2 3.7 0;
    26.4 3.9 0;
    32.6 3.8 0;
    39.9 3.4 0];
speed = [0;20;20;30;40;40];
waittime = [0;0;0;0;0;0];
