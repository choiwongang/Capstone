...
classdef TargetCarDetection < vision.labeler.AutomationAlgorithm
    ...
    properties(Constant)
        ...
        Name = 'TargetCar Detection';
        
        % Description: Provide a one-line description for your algorithm.
        Description = 'This is a automatic TargetCar labeling algorithm.';
    ...
    methods
        ...
        function isValid = checkLabelDefinition(algObj, labelDef)
            ...
            if (strcmpi(labelDef.Name, 'TargetCar') && labelDef.Type == labelType.Rectangle)
                isValid = true;
                algObj.TargetCarName = labelDef.Name;
